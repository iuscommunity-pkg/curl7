...
Provides: lib%{real_name} = %{version}-%{release}
Conflicts: lib%{real_name} < %{basever}
Requires: libssh2%{?_isa} >= %{libssh2_version}

%description -n libcurl7
...
%package -n libcurl7-devel
Summary: Files needed for building applications with libcurl
Group: Development/Libraries
Conflicts: lib%{real_name}-devel < %{basever}
...
%post -n libcurl7 -p /sbin/ldconfig

%postun -n libcurl7 -p /sbin/ldconfig
